 ...
 * Generated for Laravel 7.13.0 on 2020-05-27 11:54:26.
 *
...
namespace Marprinhm\Midtrans\Facades { 
    ...
    class Midtrans {
        ...
        {
                        return \Marprinhm\Midtrans\Midtrans::getSnapToken($body);
        }
        ...
        {
                        return \Marprinhm\Midtrans\Midtrans::status($order_id);
        }
        ...
        {
                        return \Marprinhm\Midtrans\Midtrans::approve($order_id);
        }
        ...
        {
                        return \Marprinhm\Midtrans\Midtrans::cancel($order_id);
        }
        ...
        {
                        return \Marprinhm\Midtrans\Midtrans::expire($order_id);
        }
    ...
    class Veritrans {
        ...
        {
                        return \Marprinhm\Midtrans\Veritrans::vtwebCharge($body);
        }
        ...
        {
                        return \Marprinhm\Midtrans\Veritrans::vtdirectCharge($body);
        }
        ...
        public static function status($order_id)
        {
                        return \Marprinhm\Midtrans\Veritrans::status($order_id);
        }
        ...
        public static function approve($order_id)
        {
                        return \Marprinhm\Midtrans\Veritrans::approve($order_id);
        }
        ...
        public static function cancel($order_id)
        {
                        return \Marprinhm\Midtrans\Veritrans::cancel($order_id);
        }
        ...
        public static function expire($order_id)
        {
                        return \Marprinhm\Midtrans\Veritrans::expire($order_id);
        }
...
namespace  { 
    ...
    class Midtrans extends \Marprinhm\Midtrans\Facades\Midtrans {}

    class Veritrans extends \Marprinhm\Midtrans\Facades\Veritrans {}
